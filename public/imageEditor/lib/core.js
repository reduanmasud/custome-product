...
(function () {
   ...
   */
  var ImageEditor = function (containerSelector, buttons, shapes, backgroundImageUrl = null) {
    ...
    /**
     * Event handler to set background image
     * @param {String} url image url
     */
    this.setBackgroundImage = (url) => {
      this.canvas.setBackgroundImage(url).requestRenderAll();
    }
    ...
    this.init = () => {
      ...
      this.canvas = this.initializeCanvas(this.backgroundImageUrl);
