            ...
            <form action="{{ route('admin.product.update', $product->id) }}" method="post" enctype="multipart/form-data" id="productForm">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('name', $product->name) }}" name="name" class="form-control @error('name') is-invalid @enderror"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('sku', $product->sku) }}" name="sku" class="form-control @error('sku') is-invalid @enderror"
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description"
                        rows="4" placeholder="Enter detailed product description" required>{{ old('description', $product->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div id="variation-container">
                            <div class="alert alert-info" id="no-variations">
                                <i class="fas fa-info-circle"></i> Click "Add Variation" to add new product images and color variations.
                            </div>
                            <div id="variation">
        ...
        $(document).ready(function() {
            ...
            $('#add_variation').click(function() {
                ...
                <div class="variation-item mb-3">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <span>New Variation ${count_var+1}</span>
